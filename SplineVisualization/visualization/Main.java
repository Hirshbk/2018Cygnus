...
public class Main {
	...
	private static void createAndShowUI() {
		...
		String splineName = "Gear_Red"; //name of spline .txt file
		...
		try {
//		    fieldImage = ImageIO.read(new File("D:/MyProfile/Pictures/FRC2018FieldDiagramHalf.png"));
			fieldImage = ImageIO.read(new File("FRC2018FieldDiagramHalf.png"));
		    splineImagePNG = ImageIO.read(new File(splineName + "_Graph.PNG"));
		} catch (IOException e) {
